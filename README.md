...
**Shif-Box** is an official [Mozilla Thunderbird add-on](https://addons.mozilla.org/en-US/thunderbird/addon/shift-box/). It adds a visual overlay on top of the INBOX, similar as video control players, replay their emails the way they arrived. It allows features such as:

* Pause your current inbox flow and focus on already arrived emails
* Open Thunderdird and replay previously arrived emails
* Replay a particular thread or conversation

<img src="shift-box-illus.png" style="width:400px"/>
